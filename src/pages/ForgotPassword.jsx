...
const ForgotPassword = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.post('http://localhost:5000/api/auth/forgot-password', { accessNumber });
            ...
            <div className="d-flex align-items-center justify-content-center" style={{ minHeight: 'calc(100vh - 100px)' }}>
                <Container style={{
                    ...
                    <div className="text-center pt-5 pb-4 px-4">
                        <div className="mb-2">
                            <h2 className="fw-bold m-0" style={{ color: '#fff', letterSpacing: '1px', fontFamily: 'Aptos, sans-serif' }}>PASSWORD RESET</h2>
                        </div>
                    ...
                    <div className="px-5 pb-5">
                        ...
                        <p style={{ color: '#fff', marginBottom: '20px', textAlign: 'center' }}>
                            Enter your access number and we'll send a password reset link to your email.
                        </p>
